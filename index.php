...
<section class="content-section no-top-spacing">
  <div class="container">
    <div class="row">
      <div class="col-lg-5">
        <figure class="video-thumb"> <img src="images/video-thumb.jpg" alt="Image"> <a href="videos/video01.mp4" data-fancybox>Play Button</a> </figure>
        <!-- end video-thumb -->
      </div>
      <!-- end col-5 -->
      <div class="col-lg-7">
        <div class="track-shipping-form">
          <div class="inner">
            ...
            <!-- <div class="form-group">
                      <button type="submit" disabled onclick="location.href='track/index.php'"><i class="lni lni-search-alt"></i> SEARCH</button>
                  </div> -->
            <!-- end form-group -->
          </div>
          <!-- end inner -->
    ...
    <div class="row align-items-center">
      <div class="col-lg-7">
        <div class="side-content">
          ...
          <p>QuantumQuik ship is a leading third party contract logistics company
