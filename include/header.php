...
<head>
    ...
    <title>Cargo Freight Airs| Logicstic Shipping Company</title>
    ...
    <!-- SOCIAL MEDIA META -->
    <meta property="og:description" content="Cargo Freight Airs| Logicstic Shipping Company">
    <meta property="og:image" content="preview.html">
    <meta property="og:site_name" content="Swift Cargo Delivery">
    <meta property="og:title" content="Swift Cargo Delivery">
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://www.themezinho.net/Swift Cargo Delivery">
    <!-- TWITTER META -->
    <meta name="twitter:card" content="summary">
    <meta name="twitter:site" content="Swift Cargo Delivery">
    <meta name="twitter:creator" content="Swift Cargo Delivery">
    <meta name="twitter:title" content="Swift Cargo Delivery">
    <meta name="twitter:description" content="Cargo Freight Airs| Logicstic Shipping Company">
...
<body>
    <div class="preloader"> <img src="images/preloader.png" alt="Image"> </div>
    <!-- end preloader -->
    <div class="page-transition"></div>
    <!-- end page-transition -->
    <aside class="side-widget">
        <div class="inner">
            <!-- <div class="logo"> <a href="index-2.html"><img src="#" alt="Image" width="150px"></a> </div> -->
            <!-- end logo -->
            ...
            <div class="show-mobile">
                ...
                <div class="site-menu">
                    <ul>
                        ...
                        <li><a href="https://track.cargo-freightairs.com">Track</a></li>
            ...
            <!-- end show-mobile -->
            <small>© 2023 Cargo Freight Airs| Logicstic Shipping Company</small>
        </div>
        <!-- end inner -->
    </aside>
    <!-- end side-widget -->
